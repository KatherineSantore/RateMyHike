...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://rate-my-hike-api.herokuapp.com/',
...
var postEvents = __webpack_require__(14);
// styles
...
var onGetPosts = function onGetPosts(data) {
  event.preventDefault();
  api.getPosts().then(ui.getPostsSuccess).catch(ui.getPostsFailure);
};

var onNewPost = function onNewPost() {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.newPost(data).then(ui.newPostSuccess).catch(ui.newPostError);
};
...
var onUpdatePost = function onUpdatePost(event) {
  ...
  api.updatePost(data, postId).then(ui.updatePostSuccess).then(onGetPosts()).catch(ui.updatePostFailure);
};

var onGetPost = function onGetPost() {
  event.preventDefault();
  api.displayPost().then(ui.getPostSuccess).catch(ui.getPostFailure);
};

var onDeletePost = function onDeletePost(event) {
  event.preventDefault();
  var postId = $(event.target).attr('data-id');
  api.deletePost(postId).then(ui.deletePostSuccess).catch(ui.failure);
};
...
var newPost = function newPost(data) {
  return $.ajax({
    method: 'POST',
...
var updatePost = function updatePost(data, postId) {
  return $.ajax({
    method: 'PATCH',
...
var showPostsTemplate = __webpack_require__(17);

var newPostSuccess = function newPostSuccess(data) {
  $('#post-announcer').html('You have successfully created a new post! Click Show Posts to view it!');
  store.post = data.post;
  document.getElementById('create-post-form').reset();
};
var newPostError = function newPostError() {
...
var deletePostError = function deletePostError() {
  $('#announcer').html('Please try again');
};
var getPostsSuccess = function getPostsSuccess(data) {
  var showNewPostsHtml = showPostsTemplate({ posts: data.posts });
...
var getPostsError = function getPostsError() {
  $('#announcer').html('Please try again');
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n\n\n<h1> <small>"
    ...
    + "</small></h1>\n  <div>\n    <li>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.location : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </li>\n  </div>\n  <div>\n    <li>\n"
    ...
    + "\">\n   <div class=\"form-group\">\n    <label for=\"formGroupExampleInput\">Title</label>\n    <input name = \"post[title]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "\" type=\"text\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"form-control\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"formGroupExampleInput\">Location</label>\n    <input name =\"post[location]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.location : stack1), depth0))
    + "\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"text\" class=\"form-control\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"formGroupExampleInput2\">Rating</label>\n    <input  name =\"post[body]\" class=\"form-control\" type=\"text\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.body : stack1), depth0))
    + "\"></input>\n  </div>\n  <button type=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"editButton btn btn-primary\">Update Post</button>\n<!-- Delete Post  -->\n  <button type=\"button\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"deleteButton btn btn-primary\">Delete Post</button>\n\n</form> <br>\n\n\n\n\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "      "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.location : stack1), depth0))
    + "\n";
